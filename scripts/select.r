...
data_subset_95_96 <- data_95_96 %>%
 select(USSCIDN, MONRACE, YEAR, MONSEX, CITIZEN, EDUCATN, AGE, OFFTYPE, STATMIN, STATMAX, DISPOSIT, TOTPRISN, XFOLSOR, XCRHISSR, DISTRICT, MONCIRC)

data_subset_96_97 <- data_96_97 %>%
 select(USSCIDN, MONRACE, YEAR, MONSEX, CITIZEN, EDUCATN, AGE, OFFTYPE2, STATMIN, STATMAX, DISPOSIT, TOTPRISN, XFOLSOR, XCRHISSR, DISTRICT, MONCIRC)
