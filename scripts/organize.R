...
write.csv(data_subset_95_96, "clean_data/selected_data/95-96.csv")
write.csv(data_subset_96_97, "clean_data/selected_data/96-97.csv")
write.csv(data_subset_97_98, "clean_data/selected_data/97-98.csv")
write.csv(data_subset_1999, "clean_data/selected_data/1999.csv")
write.csv(data_subset_2000, "clean_data/selected_data/2000.csv")
write.csv(data_subset_2001, "clean_data/selected_data/2001.csv")
write.csv(data_subset_2002, "clean_data/selected_data/2002.csv")
write.csv(data_subset_2003, "clean_data/selected_data/2003.csv")
write.csv(data_subset_2004, "clean_data/selected_data/2004.csv")
write.csv(data_subset_2005, "clean_data/selected_data/2005.csv")
write.csv(data_subset_2006, "clean_data/selected_data/2006.csv")
write.csv(data_subset_2007, "clean_data/selected_data/2007.csv")
write.csv(data_subset_2008, "clean_data/selected_data/2008.csv")
write.csv(data_subset_2009, "clean_data/selected_data/2009.csv")
write.csv(data_subset_2010, "clean_data/selected_data/2010.csv")
write.csv(data_subset_2011, "clean_data/selected_data/2011.csv")
write.csv(data_subset_2012, "clean_data/selected_data/2012.csv")
write.csv(data_subset_2013, "clean_data/selected_data/2013.csv")
write.csv(data_subset_2014, "clean_data/selected_data/2014.csv")
write.csv(data_subset_2015, "clean_data/selected_data/2015.csv")
