...
data_2009 <- read.csv("clean_data/2009.csv") 
data_2010 <- read.csv("clean_data/2010.csv") 
data_2011 <- read.csv("clean_data/2011.csv") 
data_2012 <- read.csv("clean_data/2012.csv") 
data_2013 <- read.csv("clean_data/2013.csv") 
